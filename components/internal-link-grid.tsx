            ...
            <Link key={item.href} href={item.href} className="group block h-full">
              <article className="flex h-full flex-col overflow-hidden border border-black/10 bg-white transition-colors duration-200 hover:bg-[#fbfaf6]">
                ...
                <div className="flex h-full flex-col p-4 md:p-5">
                  ...
                  <span className="mt-4 inline-flex min-h-[44px] items-center justify-center border border-black bg-black px-5 py-3 text-center text-[10px] font-medium uppercase tracking-[0.14em] text-white transition-colors group-hover:bg-black/92 sm:min-h-[46px] sm:text-[11px] sm:tracking-[0.16em]">
